...
const DinningRooms = () => {
  ...
  return (
    ...
    <div className="products-container">
      ...
      {furniture.DinningRooms.map( dinningRoom => 
        
      <div className='product'> 
        <div className="image"><img src={dinningRoom.image}/></div>
        <div className="name">{dinningRoom.text}</div>
        <div className="price">{dinningRoom.price}</div>
        <button className="addToCart"
         onClick={()=>{ 
          
          addToCart(dinningRoom.image,dinningRoom.price,dinningRoom.text) }}
        >Add To Cart</button>
      </div>
